...
- **Fold decision 21 into the definition.** Task lists (`- [x]`, adopted 2026-08-10) postdate the definition draft, so `definition.md` §4 and §5 and the reference card do not mention them yet. Add the construct during the settling pass, and give the corpus a target for the new collision — a bullet item quoting a literal `[x]` box.
